...
class ServiceRepositoryImpl implements ServiceRepository {
  ...
  @override
  Future<Either<Failure, Customer?>> findCustomerByPhone(String phone) async {
    try {
      ...
      return Right(Customer.fromJson(result.first));
    } catch (e) {
  ...
  @override
  Future<Either<Failure, Vehicle?>> findVehicleByPlate(
    String plateNumber,
  ) async {
    try {
      final db = await dbProvider.database;
      ...
      if (result.isEmpty) return const Right(null);
      return Right(Vehicle.fromJson(result.first));
    } catch (e) {
      return Left(ServerFailure());
    }
  }
  ...
  @override
  Future<Either<Failure, Vehicle>> saveVehicle(Vehicle vehicle) async {
    try {
      final db = await dbProvider.database;
  ...
  @override
  Future<Either<Failure, ServiceOrder>> addServiceOrder(
    ServiceOrder order,
  ) async {
    try {
      final db = await dbProvider.database;
  ...
  Future<Either<Failure, ServiceOrder>> addServiceItem(
    ...
    try {
      ...
      final currentItems = List<dynamic>.from(
        jsonDecode(results.first['items'] as String),
      );
